...
export default function FormDialog() {
  ...
  function addExpense(props) {
    let count = 1,
      total = 0;
    if (localStorage.getItem("count")) count = localStorage.getItem("count");
    else {
      localStorage.setItem("count", 1);
      localStorage.setItem("expenses", {});
    }
    if (localStorage.getItem("total")) total = localStorage.getItem("total");
    else {
  ...
  function deleteCard(index, price) {
    let count = 1,
      total = 0;
    if (localStorage.getItem("count")) count = localStorage.getItem("count");
...

  {
    ...
    for (let i = 0; i < expenses.length; i++) {
      temp1.push(
        <Card
          deleteCard={(index, price) => deleteCard(index, price)}
          key={i}
          index={i}
        ...
        <DialogContent>
          ...
          <FormControl className={classes.formControl}>
            ...
            >
              ...
              <MenuItem value={10}>
                <MdShoppingCart /> Clothing
              </MenuItem>
              <MenuItem value={20}>
                <GiMilkCarton /> Eateries
              </MenuItem>
              <MenuItem value={30}>
          ...
          <Button
            onClick={(e) => {
              ...
              addExpense({
                ...
                type: document.getElementById("demo-simple-select-autowidth")
                  .innerText,
              });
            }}
            color="primary"
